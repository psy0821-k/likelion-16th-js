...
let product_1_subtotal = parseInt(PRODUCT_1_PRICE, 10) * parseInt(PRODUCT_1_QUANTITY, 10)
console.log("product_1" + " | 기격 = " + PRODUCT_1_PRICE + " | 갯수 = " + PRODUCT_1_QUANTITY + " | 총 가격 = " + product_1_subtotal);
// 두 번째 상품의 소계를 계산하세요.
// 출력 결과: 144000 (number)
let product_2_subtotal = Number(PRODUCT_2_PRICE) * PRODUCT_2_QUANTITY

console.log("product_2" + " | 기격 = " + PRODUCT_2_PRICE + " | 갯수 = " + PRODUCT_2_QUANTITY + " | 총 가격 = " + product_2_subtotal, typeof(product_1_subtotal));

// 세 번째 상품의 소계를 계산하세요.
// 출력 결과: 25000 (number)
let product_3_subtotal =PRODUCT_3_PRICE * Number(PRODUCT_3_QUANTITY)
console.log("product_3" + " | 기격 = " + PRODUCT_3_PRICE + " | 갯수 = " + PRODUCT_3_QUANTITY + " | 총 가격 = " + product_3_subtotal);
...
console.log("배송비 = " + SHIPPING_FEE  + "\n" +"배송비 포함 가격 : " + total_with_shipping);
console.log("----------------------------------------------------------------");
...
console.log("할인 된 가격 : " + discount_amount);

console.log("----------------------------------------------------------------");
// 최종 결제 금액을 계산하세요.
// 출력 결과: 217800 (number)
let final_payment = cart_total - discount_amount + Number(SHIPPING_FEE)
console.log("최종 결제 금액 : " + final_payment);
...
console.log("포인트 적립금 : " + earned_points);
console.log("----------------------------------------------------------------");
...
console.log("할인 쿠폰 : " + COUPON_AMOUNT + "원\n" + "쿠폰 사용시 최종 금액 : " + payment_with_coupon);
...
console.log("현재 나이 : " + age_number);
// 내년 나이를 계산하세요.
// 출력 결과: 29 (number)
let next_year_age = age_number + 1
console.log("내년 나이 : " + next_year_age);

// 키를 숫자로 변환하세요.
// 출력 결과: 175.5 (number)
let height_number = Number(USER_HEIGHT)
console.log("키 : " + height_number + "cm");
// 몸무게를 숫자로 변환하세요.
// 출력 결과: 70 (number)
let weight_number = Number(USER_WEIGHT)
console.log("몸무게 : " + weight_number + "kg");
// BMI를 계산하세요. (몸무게 / (키/100)²)
// 출력 결과: 약 22.73 (number)
let bmi = Number((weight_number / ((height_number / 100) ** 2)).toFixed(2));
console.log("약" + bmi);
